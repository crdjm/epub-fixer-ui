      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">
            EPUB Accessibility: Creating Inclusive Digital Publications
          </h1>

          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-8">
              Accessibility in digital publishing is not just a legal
              requirement or ethical obligation—it's a fundamental aspect of
              inclusive design that ensures all readers, regardless of their
              abilities, can access and enjoy your content. Understanding EPUB
              accessibility and the role of tools like DAISY ACE is crucial for
              modern publishers.
            </p>

            <div className="bg-blue-50 rounded-lg p-6 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                Why EPUB Accessibility Matters
              </h2>
              <p className="text-gray-700 mb-4">
                Accessible EPUB publications ensure that people with
                disabilities can read and interact with digital content using
                assistive technologies such as screen readers, magnifiers, and
                alternative input devices. This includes readers with visual,
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      interface components must be presentable to users in ways
                      they can perceive
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Understandable:</strong> Information and operation
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Robust:</strong> Content must be robust enough to
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                DAISY ACE: The Accessibility Checker for EPUB
              </h2>

              <div className="bg-purple-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
                  ACE (Accessibility Checker for EPUB) is a free, open-source
                  tool developed by the DAISY Consortium that performs automated
                  accessibility checks on EPUB publications. Unlike EPUBCheck
                  which focuses on technical validation, ACE specifically
                  evaluates accessibility compliance.
                </p>
                <p className="text-gray-700">
                  ACE integrates the power of Axe-core accessibility engine with
                  EPUB-specific rules to identify potential accessibility issues
                  and provide actionable feedback for content creators.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-purple-500 pl-4 py-1">
                  ...
                  <p className="text-gray-700">
                    ACE analyzes EPUB files by examining content documents,
                    navigation structures, and metadata to identify
                    accessibility issues. It generates detailed reports that
                    categorize issues by severity and provide guidance on how to
                    resolve them.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-purple-500 pl-4 py-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    Key Features of DAISY ACE
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                    <li>
                      Automated accessibility testing based on WCAG 2.0 AA
                      standards
                    </li>
                    <li>
                      EPUB-specific accessibility rules and best practices
                    </li>
                ...
                <div className="border-l-4 border-purple-500 pl-4 py-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    Benefits of Using DAISY ACE
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                    <li>
                      Early identification of accessibility issues in the
                      production process
                    </li>
                    <li>
                      Consistent evaluation against established accessibility
                      standards
                    </li>
                    <li>Reduced manual testing time and effort</li>
                    <li>
                      Improved quality and compliance of published content
                    </li>
                    <li>
                      Enhanced user experience for readers with disabilities
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                Accessibility Issues We Automatically Fix
              </h2>
              <p className="text-gray-700 mb-4">
                Our service automatically resolves common accessibility issues
                identified by DAISY ACE to ensure your publications are
                inclusive:
              </p>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    html-has-lang: HTML documents missing language attributes
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    document-title: Documents missing title elements
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    heading-order: Incorrect heading structure and hierarchy
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    empty-heading: Headings with no visible text
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    link-in-text-block: Links not distinguishable from
                    surrounding text
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    epub-type-has-matching-role: EPUB type attributes without
                    matching ARIA roles
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    OPF-096: Non-linear content not reachable
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    landmark-unique: Landmark elements without unique accessible
                    names
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    metadata-*: Missing accessibility metadata
                  </h3>
                  <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
              ...
              <div className="mt-6 p-4 bg-blue-100 rounded-lg">
                <p className="text-blue-800">
                  ...
                  when running our tool in fix mode. AI-powered alt text
                  generation is available using the --use-gemini flag to use
            ...
            <div className="bg-indigo-50 rounded-lg p-6 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                Best Practices for Accessible EPUB Creation
              </h2>
            ...
            <div className="text-center mt-12">
              ...
              <p className="mt-4 text-gray-600">
                Ensure your publications are inclusive and accessible to all
                readers
              </p>
            </div>
          </div>
