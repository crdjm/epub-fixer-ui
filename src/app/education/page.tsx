      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6 text-center">
            EPUB Education Center
          </h1>

          <p className="text-xl text-gray-700 text-center mb-12">
            Learn about EPUB formats, validation, and accessibility to create
            better digital publications
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-indigo-50 to-blue-100 rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Discover the benefits of EPUB 3 and why upgrading from EPUB 2
                  is essential for modern digital publishing.
                </p>
                <Link
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Understand EPUBCheck and why validation is crucial for
                  creating compliant, high-quality EPUB files.
                </p>
                <Link
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Learn about EPUB accessibility and how DAISY ACE helps create
                  inclusive digital publications for all readers.
                </p>
                <Link
          ...
          <div className="mt-16 bg-blue-50 rounded-xl p-8">
            ...
            <p className="text-gray-700 text-center mb-6">
              We automatically fix common issues identified by EPUBCheck and
              DAISY ACE to ensure your publications meet industry standards.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <Link
                  href="/education/epubcheck"
                  className="text-indigo-600 hover:text-indigo-800 text-sm font-medium mt-3 inline-block"
                >
          ...
          <div className="text-center mt-12">
            ...
            <p className="mt-4 text-gray-600">
              Upload your files to automatically convert, validate, and fix
